...
//	public static WebDriver oBrowser= null;
	...
	static void modifiyuser()
	{
		...
		//	oBrowser.findElement(By.xpath("*[@id='userListTableContainer']/table/tbody/tr[2]/td[1]/table/tbody/tr/td/div[1]/span[2]")).click();
			...
			//oBrowser.findElement(By.xpath("*[@id='userDataLightBox_firstNameField']")).sendKeys();
			oBrowser.findElement(By.xpath("//*[@id='userListTableContainer']/table/tbody/tr[2]/td[1]/table/tbody/tr/td/div[1]/span[2]")).click();
			oBrowser.findElement(By.xpath("//*[@id='userDataLightBox_lastNameField']")).sendKeys("santhosh");
		//	oBrowser.findElement(By.name("lastName")).sendKeys("santhosh");
			Thread.sleep(4000);
			oBrowser.findElement(By.xpath("//*[@id='userDataLightBox_commitBtn']/div/span")).click();
		//	oBrowser.findElement(By.xpath("//*[@id=\'userDataLightBox_commitBtn\']/div/span")).click();
			Thread.sleep(2000);
